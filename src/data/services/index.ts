...
export const ai: ServicePageData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      desc: 'Book a technical briefing with our AI engineers to evaluate your data readiness and identify the highest-value automation opportunities.',
...
export const seo: ServicePageData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      desc: 'Get a structured technical SEO audit covering crawlability, Core Web Vitals, schema markup, and indexing configuration.',
...
export const digitalMarketing: ServicePageData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      desc: 'Book a campaign performance review. We will audit your current ad structure and identify immediate optimization opportunities.',
...
export const cloud: ServicePageData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      desc: 'Get a cloud infrastructure audit. We will identify cost inefficiencies, security gaps, and scaling constraints in your current environment.',
...
export const cybersecurity: ServicePageData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      desc: 'Schedule a confidential security briefing with our penetration testing engineers to assess your current risk profile.',
...
export const devops: ServicePageData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      desc: 'Talk to our DevOps engineers about setting up a CI/CD system that ships your code faster with zero-downtime deployments.',
...
export const dataEngineering: ServicePageData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      content: 'Most organizations are sitting on valuable data trapped in disconnected systems, inconsistent formats, and inaccessible silos. We design and build the infrastructure to extract that data, standardize it, and load it into queryable warehouses that power dashboards, reports, and machine learning models. Our pipelines are observable, fault-tolerant, and built to run unattended.',
    },
    {
      id: 'capabilities',
      type: 'capabilities',
    ...
    },
    {
      ...
      desc: 'Schedule a data architecture review. We will map your current data sources and design a unified pipeline strategy.',
...
export const mobileAppDevelopment: ServicePageData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      content: 'We build cross-platform and native mobile applications that prioritize real-world performance — smooth 60fps animations, offline data access, biometric authentication, and deep device hardware integration. Our apps ship with robust testing suites, CI/CD pipelines for App Store deployment, and backend API architectures built to handle mobile traffic patterns.',
    },
    {
      id: 'capabilities',
      type: 'capabilities',
    ...
    },
    {
      ...
      desc: 'Discuss your mobile app requirements with our engineers and get a technical scope estimate within one week.',
...
export const webDevelopment: ServicePageData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      content: 'We engineer web applications that combine fast, server-rendered React frontends with secure, documented backend APIs. Whether building a customer-facing portal, a complex SaaS dashboard, or an enterprise data interface, our implementations prioritize Core Web Vitals scores, accessibility standards, and API security best practices from day one.',
    },
    {
      id: 'capabilities',
      type: 'capabilities',
    ...
    },
    {
      ...
      desc: 'Discuss your web project with our senior engineers and receive a structured technical proposal within five business days.',
...
export const uiUx: ServicePageData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      content: 'We design interfaces grounded in user research and structured design system methodology. Every project begins with journey mapping, progresses through wireframe blueprints, and delivers production-ready Figma component libraries that engineering teams can implement directly. Our designs are tested with interactive prototypes before a single line of code is written.',
    },
    {
      id: 'capabilities',
      type: 'capabilities',
    ...
    },
    {
      ...
      desc: 'Book a design discovery session to review your current interface, map user journeys, and scope a design system engagement.',
...
export const itConsulting: ServicePageData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      desc: 'Arrange an executive briefing with our principals to discuss your technology strategy and evaluate how we can support your leadership team.',
...
export const automation: ServicePageData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      desc: 'Schedule a process audit session. We will identify your highest-value automation targets and estimate implementation timelines.',
...
export const branding: ServicePageData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      content: 'A brand system is the visual language your company speaks across every touchpoint. We create comprehensive brand guides that define your typographic scale, color system, logo variants, and spacing rules — then translate these into production-ready design tokens and Figma component libraries that your engineering team can use directly in product interfaces.',
    },
    {
      id: 'capabilities',
      type: 'capabilities',
    ...
    },
    {
      ...
      desc: 'Schedule a brand discovery session to review your current identity and scope a comprehensive brand system engagement.',
