...
export const BlogPage: React.FC<BlogPageProps> = ({ slugProp, onOpenConsultation }) => {
    ...
    <>
      ...
      <div className="blog-page-container">
        <div className="container">
          ...
          {/* Back link */}
          <div onClick={() => navigate('/blog')} className="back-to-blog-link" role="button" tabIndex={0}>
            <ArrowLeft size={16} />
          ...
          >
            ...
            <div className="adj-nav-section">
              {prev ? (
                <div onClick={() => navigate(`/blog/${prev.slug}`)} className="adj-nav-link" role="button" tabIndex={0}>
              ...
              {next ? (
                <div onClick={() => navigate(`/blog/${next.slug}`)} className="adj-nav-link" style={{ textAlign: 'right', alignItems: 'flex-end' }} role="button" tabIndex={0}>
                  <span className="adj-nav-label">
